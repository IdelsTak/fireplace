...
// part 1 :
// https://web.archive.org/web/20071213073907/http://www.clientjava.com/blog/2004/08/20/1093059428000.html
// part 2 :
// https://web.archive.org/web/20071213073907/http://www.clientjava.com/blog/2004/08/24/1093363375000.html
// part 3 :
// https://web.archive.org/web/20071213073907/http://www.clientjava.com/blog/2004/08/31/1093972473000.html
 ...
 * See <a href="http://java.sun.com/docs/books/tutorial/uiswing/misc/threads.html">How to Use
 * Threads</a> for more info
 *
 * <p>This is a modification of original idea of Scott Delap.<br>
 *
 * @author Scott Delap
 * @author Alexander Potochkin
 *     <p>https://swinghelper.dev.java.net/
 */
public class CheckThreadViolationRepaintManager extends RepaintManager {
  ...
  /**
   * Rules enforced by this method: (1) it is always OK to reach this method on the Event Dispatch
   * Thread. (2) it is generally not OK to reach this method outside the Event Dispatch Thread. (3)
   * (exception form rule 2) except when we get here from a repaint() call, because repaint() is
   * thread-safe (4) (exception from rule 3) it is not OK if swing code calls repaint() outside the
   * EDT, because swing code should be called on the EDT. (5) (exception from rule 4) using
   * SwingWorker subclasses should not be considered swing code.
   */
  ...
  void violationFound(JComponent c, StackTraceElement[] stackTrace) {
    ...
    for (int i = 1; i < stackTrace.length; i++) {
      ...
      //                || Objects.requireNonNullElse(stackTrace[i].getModuleName(),
      // "").startsWith("java")
