...
public class DarkLightColor extends Color {
  ...
  public float[] getRGBComponents(float[] compArray) {
    ...
    return current == this
        ...
        : current.getRGBComponents(compArray);
  }
  ...
  public float[] getRGBColorComponents(float[] compArray) {
    var current = currentColor();
    return current == this
        ? super.getRGBColorComponents(compArray)
        : current.getRGBColorComponents(compArray);
  }
  ...
  public float[] getColorComponents(float[] compArray) {
    ...
    return current == this
        ...
        : current.getColorComponents(compArray);
  }
  ...
  public float[] getComponents(ColorSpace cspace, float[] compArray) {
    ...
    return current == this
        ...
        : current.getComponents(cspace, compArray);
  }
  ...
  public float[] getColorComponents(ColorSpace cspace, float[] compArray) {
    ...
    return current == this
        ...
        : current.getColorComponents(cspace, compArray);
  }
  ...
  public synchronized PaintContext createContext(
    ...
    return current == this
        ...
        : current.createContext(cm, r, r2d, xform, hints);
  }
